...
%  plot(xNode+.5,yNode+.5,'go');
 ...
 %--------------------------------
 % Esta parte de código comprueba si los nodos expandidos se encuentran ya
 % en la lista OPEN. En cuyo caso actualiza su valor f(n) con el menor
 % entre el antiguo y el nuevo expandido mediante la función min.
